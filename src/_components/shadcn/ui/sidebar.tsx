...
import { useIsMobile } from '@/_components/shadcn/hooks/use-mobile';
        ...
        <SidebarContext value={contextValue}>
            <TooltipProvider delayDuration={0}>
                <div
                    ...
                    className={cn(
                        'group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex h-full max-h-full w-full',
                        className,
                    )}
                    {...props}
                >

...
.side {
    @apply tw-fixed tw-flex tw-flex-col tw-h-screen tw-w-60 tw-z-[999] tw-bg-[rgb(255_255_255/0.8)] dark:tw-bg-[rgba(24_24_27/0.9)] tw-bg-opacity-90 tw-backdrop-blur-sm tw-transition-transform tw-duration-300 tw-ease-out -tw-translate-x-full;
...
.mobileToc {
    @apply tw-fixed tw-flex tw-items-center tw-right-0 tw-top-16 tw-z-10 tw-top-[30%] tw-overflow-hidden tw-transition-transform tw-duration-300 tw-ease-out;
    ...
    & > .mobileTocMain {
        @apply tw-h-full tw-w-56 tw-bg-[rgb(255_255_255/0.8)] dark:tw-bg-[rgba(24_24_27/0.9)] tw-backdrop-blur-sm tw-drop-shadow-sm tw-shadow-lg tw-rounded-tl-lg tw-rounded-bl-lg tw-py-2;
...
if (!isNil(post)) router.push(`/posts/${post.slug || post.id}`);
```

...
![effect.gif](https://cdn.jsdelivr.net/gh/amingdrift/picBed/img/effect.gif)
    ...
    return (
        <>
            ...
            <div className="resizecont rightone">
                <div className="h-full">
                    <div
                        className="edgrsz hdws cursor-e-resize"
                        data-op="1"
                        onMouseDown={toolDrag}
                        data-vec="0,1"
                    ></div>
            ...
            <div className="resizecont bottomone">
                <div className="flex">
                    ...
                    ></div>
                    <div
                        className="edgrsz wdws cursor-s-resize"
                        data-op="1"
                        onMouseDown={toolDrag}
                        data-vec="1,0"
                    ></div>
    ...
    return (
        <Modal app={list[routerName]} name={routerName}>
            <SidebarProvider defaultOpen={true}>
                ...
                <main className="flex w-full flex-col overflow-x-auto">
                    <SidebarTrigger />
...
@layer components {
    ...
    .actbtns {
        ...
        .actbtn {
            @apply flex h-full cursor-pointer items-center justify-center px-1 transition-all hover:bg-[#88888833];
